...
#def hiroya_syn(answer):
#    datamake = 'echo "' + answer + '" > /tmp/dialogue/out.txt; '
#    output = 'syn/01mk_label.sh /tmp/dialogue/out.txt > /tmp/dialogue/out.jeita; '
#    synth = 'syn/02synthesize.sh /tmp/dialogue/out.jeita mht; '
#    play = 'play -q /tmp/dialogue/out.wav; rm /tmp/dialogue/out.wav;'
#    return datamake + output + synth + play
